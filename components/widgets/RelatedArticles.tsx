...
export async function RelatedArticles({ categoryId, excludeArticleId }: RelatedArticlesProps) {
  const articles = await getRelatedArticles(categoryId, excludeArticleId, 5)
